...
set "TE_REMOTE=https://raw.githubusercontent.com/JorgeSport/te-equipamos/main/tools/publicador-te-equipamos/PUBLICAR-TE-EQUIPAMOS.ps1"
set "TE_TMP=%TEMP%\PUBLICAR-TE-EQUIPAMOS-%RANDOM%%RANDOM%.ps1"
curl.exe -L --fail --silent --show-error "%TE_REMOTE%" -o "%TE_TMP%" >nul 2>&1
if not errorlevel 1 (
