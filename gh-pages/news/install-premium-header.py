...
header = f'''<header class="top tePremiumHeader" id="tePremiumHeader">
  <div class="row tePremiumHeaderRow">
    <a href="{OFFICIAL_URL}" class="brand" aria-label="Ir al inicio de Te Equipamos"><span class="mark" aria-hidden="true">TE</span><span class="teBrandName">Te Equipamos</span></a>
...
:root{--te-header-bg:#2A2D2A;--te-header-fg:#F3F4F0;--te-header-muted:#C5C9C4;--te-header-h:74px}
#tePremiumHeader{position:sticky;top:0;z-index:120;background:var(--te-header-bg)!important;border:0!important;box-shadow:0 1px 0 rgba(255,255,255,.05);backdrop-filter:none!important;color:var(--te-header-fg)}
...
#tePremiumHeader .brand{display:flex;align-items:center;color:var(--te-header-fg)!important;text-decoration:none;min-width:44px}
#tePremiumHeader .mark{width:auto!important;height:auto!important;border-radius:0!important;background:transparent!important;color:var(--te-header-fg)!important;font-size:19px!important;line-height:1!important;font-weight:800!important;letter-spacing:-.07em!important}
...
#tePremiumHeader .icon:hover{background:rgba(255,255,255,.08)!important}
...
#tePremiumHeader .tePremiumSearch{position:absolute!important;left:50%!important;top:calc(100% + 10px)!important;transform:translate(-50%,-8px)!important;width:min(760px,calc(100vw - 32px))!important;height:54px!important;margin:0!important;padding:0 18px!important;display:flex!important;align-items:center!important;gap:12px!important;background:var(--surface)!important;border:1px solid var(--line)!important;border-radius:18px!important;box-shadow:0 18px 55px rgba(16,20,17,.18)!important;opacity:0;visibility:hidden;pointer-events:none;transition:opacity .18s ease,transform .18s ease,visibility .18s ease;z-index:125}
...
#tePremiumHeader .teSearchGlyph{width:22px;height:22px;fill:none;stroke:var(--muted);stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round;flex:0 0 auto}
#tePremiumHeader .tePremiumSearch input{font-size:16px;color:var(--text)!important;background:transparent!important;border:0!important;outline:0!important;min-width:0;flex:1}
#tePremiumHeader .tePremiumSearch input::placeholder{color:var(--muted)}
#tePremiumHeader #clearBtn{width:34px;height:34px;border:0;border-radius:50%;background:var(--surface2);color:var(--muted);font-size:21px;line-height:1;cursor:pointer}
...
.teHeaderMenu{position:fixed;z-index:129;top:0;right:0;width:min(420px,92vw);height:100dvh;background:var(--surface);color:var(--text);box-shadow:-20px 0 60px rgba(8,10,8,.18);transform:translateX(102%);transition:transform .28s cubic-bezier(.2,.75,.25,1);overflow:auto;overscroll-behavior:contain}
...
.teHeaderMenuBrand{font-size:13px;font-weight:900;letter-spacing:.08em;color:var(--text);text-decoration:none}
.teHeaderMenuClose{width:42px;height:42px;display:grid;place-items:center;border:0;border-radius:50%;background:transparent;color:var(--text);cursor:pointer}
...
.teHeaderMenuSections button{width:100%;border:0;background:transparent;color:var(--text);text-align:left;padding:11px 2px;font-size:27px;line-height:1.15;font-weight:650;letter-spacing:-.035em;cursor:pointer}
...
.teHeaderTool{width:100%;min-height:45px;border:0;background:transparent;color:var(--text);display:flex;align-items:center;justify-content:space-between;gap:14px;text-decoration:none;padding:8px 2px;font-size:14px;cursor:pointer;text-align:left}
...
html=re.sub(r'<meta name="theme-color" content="[^"]*">','<meta name="theme-color" content="#2A2D2A">',html,count=1)
...
print('Cabecera premium instalada: TE + búsqueda + menú, sin bolsa')
