...
.journey{margin-top:38px}.journeyShell{padding:0;background:transparent;border:0;box-shadow:none}.journeyHead{display:flex;justify-content:space-between;gap:24px;align-items:end;margin-bottom:12px}.journeyHead h2{margin:6px 0 0;font-size:27px;letter-spacing:-.03em}.journeyHead p{margin:0;max-width:520px;color:var(--muted);font-size:13px;line-height:1.55}.journeyGrid,.journeyGrid.count1,.journeyGrid.count2{display:grid;grid-template-columns:1fr;grid-auto-rows:auto;gap:0;border-top:1px solid var(--line)}.journeyCard,.journeyGrid.count1 .journeyCard,.journeyGrid.count2 .journeyCard{appearance:none;grid-column:auto;grid-row:auto;border:0;border-bottom:1px solid var(--line);background:transparent;color:var(--text);border-radius:0;padding:0;text-align:left;cursor:pointer;overflow:hidden;min-width:0;transition:background .16s ease}.journeyCard:hover{transform:none;box-shadow:none;background:color-mix(in srgb,var(--surface2) 52%,transparent)}.journeyCardInner,.journeyHero .journeyCardInner,.journeySide .journeyCardInner,.journeyWide .journeyCardInner{min-height:116px;display:grid;grid-template-columns:112px minmax(0,1fr);gap:16px;align-items:center;padding:14px 2px;min-width:0}.journeyCardInner:not(:has(.journeyMedia)){grid-template-columns:1fr;min-height:auto;padding:18px 2px}.journeyCopy,.journeyHero .journeyCopy,.journeySide .journeyCopy,.journeyWide .journeyCopy{padding:0;display:block;min-width:0}.journeyCopy small{display:block;color:var(--accent);font-weight:900;font-size:10px;letter-spacing:.07em;text-transform:uppercase;margin-bottom:6px}.journeyCopy strong,.journeyHero .journeyCopy strong,.journeyWide .journeyCopy strong{display:block;font-size:18px;line-height:1.25;letter-spacing:-.01em}.journeyCopy p,.journeySide .journeyCopy p,.journeyWide .journeyCopy p{display:block;margin:5px 0 0;color:var(--muted);font-size:12px;line-height:1.42}.journeyCta{display:inline-block;margin-top:7px;color:var(--accent);font-size:11px;font-weight:900}.journeyMedia,.journeyWide .journeyMedia{order:-1;width:112px;height:88px;overflow:hidden;background:var(--surface2);border-radius:14px;min-width:0}.journeyMedia img{width:100%;height:100%;display:block;object-fit:cover;transition:transform .25s ease}.journeyCard:hover img{transform:scale(1.02)}.journeyHero,.journeySide,.journeyWide{grid-column:auto;grid-row:auto}
@media(max-width:760px){.journey{margin-top:24px}.journeyHead{display:block;padding:0 4px;margin-bottom:10px}.journeyHead h2{font-size:24px}.journeyHead p{margin-top:8px}.journeyGrid,.journeyGrid.count1,.journeyGrid.count2{padding:0}.journeyCardInner,.journeyHero .journeyCardInner,.journeySide .journeyCardInner,.journeyWide .journeyCardInner{grid-template-columns:92px minmax(0,1fr);gap:12px;min-height:102px;padding:13px 2px}.journeyCardInner:not(:has(.journeyMedia)){grid-template-columns:1fr;min-height:auto;padding:16px 2px}.journeyMedia,.journeyWide .journeyMedia{order:-1;width:92px;height:74px;border-radius:11px}.journeyCopy strong,.journeyHero .journeyCopy strong,.journeyWide .journeyCopy strong{font-size:16px;line-height:1.28}.journeyCopy p,.journeySide .journeyCopy p,.journeyWide .journeyCopy p{font-size:11px}.journeyCta{margin-top:6px;font-size:11px}}
'''
...
print('Sigue explorando convertido en lista editorial compacta con miniaturas')
