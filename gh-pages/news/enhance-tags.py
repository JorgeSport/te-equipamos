...
@media(max-width:760px){.activityRow{margin:5px 0}.tagRow{margin:2px 0 10px}.tagPill{font-size:10px;padding:5px 8px}.topic{border-top-width:3px}}
...
print('Actividades y etiquetas activas: navegación por actividad separada de tags')
