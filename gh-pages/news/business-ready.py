...
# ---------- Páginas comerciales ----------
common_css = '''
:root{--bg:#F7F6F2;--surface:#fff;--text:#1D1D1F;--muted:#6C6B67;--line:#DDDCD7;--accent:#355345;--soft:#E7ECE8}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}.top{position:sticky;top:0;z-index:20;background:#2A2D2A;color:#F3F4F0}.topin{max-width:1180px;margin:auto;min-height:68px;padding:0 22px;display:flex;align-items:center;justify-content:space-between;gap:20px}.brand{font-size:18px;font-weight:800;letter-spacing:-.035em;color:inherit;text-decoration:none}.topnav{display:flex;gap:8px;align-items:center}.topnav a{color:#D7DAD6;text-decoration:none;font-size:12px;font-weight:700;padding:10px 11px;border-radius:999px}.topnav a:hover{background:rgba(255,255,255,.08);color:#fff}.wrap{max-width:1120px;margin:auto;padding:0 22px}.hero{padding:90px 0 54px}.eyebrow{font-size:11px;font-weight:900;letter-spacing:.11em;text-transform:uppercase;color:var(--accent)}h1{font-size:clamp(52px,8vw,104px);line-height:.9;letter-spacing:-.07em;margin:14px 0 24px;max-width:10ch}.lead{font-size:clamp(19px,2.1vw,26px);line-height:1.42;color:var(--muted);max-width:780px}.ctaRow{display:flex;gap:10px;flex-wrap:wrap;margin-top:28px}.cta,.ghost{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 18px;border-radius:999px;text-decoration:none;font-size:13px;font-weight:850}.cta{background:var(--accent);color:#fff}.ghost{border:1px solid var(--line);color:var(--text);background:var(--surface)}.section{padding:46px 0 70px}.section h2{font-size:clamp(34px,5vw,58px);line-height:1;letter-spacing:-.055em;margin:0 0 22px}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.card{background:var(--surface);border:1px solid var(--line);border-radius:20px;padding:23px}.card span{font-size:10px;font-weight:900;letter-spacing:.09em;text-transform:uppercase;color:var(--accent)}.card h3{font-size:20px;letter-spacing:-.025em;margin:8px 0}.card p,.copy p,.copy li{color:var(--muted);line-height:1.6}.metric{font-size:36px;font-weight:800;letter-spacing:-.055em}.note{background:var(--soft);border-radius:18px;padding:20px 22px;color:var(--muted);line-height:1.55}.copy{max-width:820px}.copy h2{font-size:32px;margin-top:42px}.copy ul{padding-left:20px}.footer{border-top:1px solid var(--line);margin-top:50px}.footerin{max-width:1120px;margin:auto;padding:30px 22px 44px;display:flex;justify-content:space-between;gap:20px;flex-wrap:wrap;color:var(--muted);font-size:12px}.footer a{color:inherit;text-decoration:none;margin-right:14px}.footer a:hover{color:var(--accent)}@media(max-width:780px){.topnav{display:none}.hero{padding-top:58px}.grid{grid-template-columns:1fr}.section{padding:34px 0 54px}.cta,.ghost{width:100%}}
'''
...
footer = '''<footer id="teBusinessFooter" style="border-top:1px solid var(--line);margin-top:54px"><div style="max-width:1180px;margin:auto;padding:26px 22px 38px;display:flex;gap:18px;justify-content:space-between;flex-wrap:wrap;color:var(--muted);font-size:11px"><strong style="color:var(--text)">Te Equipamos</strong><nav aria-label="Información de Te Equipamos"><a href="/te-equipamos-arpenaz-27l/news/metodologia/" style="color:inherit;text-decoration:none;margin-right:12px">Cómo trabajamos</a><a href="/te-equipamos-arpenaz-27l/news/anunciate/" style="color:inherit;text-decoration:none;margin-right:12px">Anúnciate</a><a href="/te-equipamos-arpenaz-27l/news/media-kit/" style="color:inherit;text-decoration:none;margin-right:12px">Media Kit</a><a href="/te-equipamos-arpenaz-27l/news/privacidad/" style="color:inherit;text-decoration:none;margin-right:12px">Privacidad</a><a href="/te-equipamos-arpenaz-27l/news/cookies/" style="color:inherit;text-decoration:none">Cookies</a></nav></div></footer>'''
